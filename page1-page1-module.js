...
/***/ "./src/app/page1/page1-list/page1-list.component.html":
/*!************************************************************!*\
  !*** ./src/app/page1/page1-list/page1-list.component.html ***!
  \************************************************************/
...
module.exports = "  <div class=\"ui-g-12\">\r\n    <p>\r\n      page1-list works!\r\n    </p>\r\n  </div>\r\n  <div class=\"ui-g-12\">\r\n    <form #userForm=\"ngForm\"  novalidate (ngSubmit) = onSubmit()>\r\n      {{userForm.value | json}}\r\n      <br>\r\n      {{page1.name}} {{page1.grade}}\r\n      <br>\r\n      <input name=\"username\" required #username1=\"ngModel\" [(ngModel)] = \"page1.name\">\r\n      <small class=\"username-input\" *ngIf=\"username1?.errors?.required\">Name is required</small>\r\n      <br>\r\n      <button name=\"button\" [disabled]=\"userForm.form.invalid\" class=\"submit-btn\" type=\"submit\"> Submit </button>\r\n    </form>\r\n  </div>\r\n\r\n\r\n\r\n"

/***/ }),

/***/ "./src/app/page1/page1-list/page1-list.component.scss":
/*!************************************************************!*\
  !*** ./src/app/page1/page1-list/page1-list.component.scss ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = ".d-none {\n  display: none; }\n\n.submit-btn {\n  margin: 10pxl;\n  height: 15px;\n  width: 100px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/page1/page1-list/page1-list.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/page1/page1-list/page1-list.component.ts ***!
  \**********************************************************/
/*! exports provided: Page1ListComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Page1ListComponent", function() { return Page1ListComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _share_page1_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../share/page1.model */ "./src/app/page1/share/page1.model.ts");
/* harmony import */ var _page1_list_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./page1-list.service */ "./src/app/page1/page1-list/page1-list.service.ts");
...
var Page1ListComponent = /** @class */ (function () {
    function Page1ListComponent(service) {
        this.service = service;
        this.page1 = new _share_page1_model__WEBPACK_IMPORTED_MODULE_1__["Page1"]('FPTA', 10);
        this.name = '';
    }
    Page1ListComponent.prototype.ngOnInit = function () {
    };
    Page1ListComponent.prototype.onSubmit = function () {
        console.log(this.page1.name);
        this.service.insert(this.name)
            .subscribe(function (data) { return console.log('success', data); }, function (error) { return console.log('error'); });
    };
    Page1ListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-page1-list',
            template: __webpack_require__(/*! ./page1-list.component.html */ "./src/app/page1/page1-list/page1-list.component.html"),
            styles: [__webpack_require__(/*! ./page1-list.component.scss */ "./src/app/page1/page1-list/page1-list.component.scss")]
        }),
        __metadata("design:paramtypes", [_page1_list_service__WEBPACK_IMPORTED_MODULE_2__["Page1Service"]])
    ], Page1ListComponent);
    return Page1ListComponent;
}());
...
/***/ "./src/app/page1/page1-list/page1-list.service.ts":
/*!********************************************************!*\
  !*** ./src/app/page1/page1-list/page1-list.service.ts ***!
  \********************************************************/
...
var Page1Service = /** @class */ (function () {
    ...
    Page1Service.prototype.insert = function (name) {
...
/* harmony import */ var _page1_list_page1_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./page1-list/page1-list.component */ "./src/app/page1/page1-list/page1-list.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: '',
        component: _page1_list_page1_list_component__WEBPACK_IMPORTED_MODULE_2__["Page1ListComponent"]
    }
];
var Page1RoutingModule = /** @class */ (function () {
...
/* harmony import */ var _page1_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./page1-routing.module */ "./src/app/page1/page1-routing.module.ts");
/* harmony import */ var _page1_list_page1_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./page1-list/page1-list.component */ "./src/app/page1/page1-list/page1-list.component.ts");
...
var Page1Module = /** @class */ (function () {
    ...
    Page1Module = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_page1_list_page1_list_component__WEBPACK_IMPORTED_MODULE_3__["Page1ListComponent"]],
            imports: [
...
/***/ "./src/app/page1/share/page1.model.ts":
/*!********************************************!*\
  !*** ./src/app/page1/share/page1.model.ts ***!
  \********************************************/
